...
componentDidMount () {
    ...
    filteringSchedule(stuff) {
        for (let i = 0; i < stuff; i++) {
            if (stuff[i] !== '') {
                stuff[i].push(stuff.fullSchedule)
                console.log(stuff)
            } else {
                console.log('else')
            }
            ...
            <div>
                ...
                <Row>
                    <Col>
                        ...
                        <input type="time" value={this.state.mondayWorkEnd} onChange={(event) => this.setState({ mondayWorkEnd: event.target.value })} />
                    </Col>
                    <Col>
                        <h4>Tuesday</h4>
                ...
                <Row>
                    <Col>
                        ...
                        <input type="time" value={this.state.mondaySchoolEnd} onChange={(event) => this.setState({ mondaySchoolEnd: event.target.value })} />
                    </Col>
                    <Col>
                        <h4>Tuesday</h4>
